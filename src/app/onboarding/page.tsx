    ...
    <div className="mx-auto max-w-md py-8">
      <div className="mb-6">
        ...
        <div className="h-2.5 rounded-full bg-tt-gray30/30">
          <div
            className="h-2.5 rounded-full bg-gradient-to-r from-tt-green to-gs-red-strong transition-all duration-300"
        ...
        <div className="animate-rise">
          ...
          <div className="mt-5 space-y-3">
            <button
              ...
              onClick={finish}
              className="w-full rounded-xl bg-gradient-to-r from-tt-green to-gs-red-strong py-3.5 font-bold text-white shadow-lg shadow-tt-green/20 transition hover:opacity-90 active:scale-95 disabled:opacity-40"
            >
              {submitting
                ? "保存中..."
                : gear.length >= 2
