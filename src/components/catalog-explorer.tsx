          ...
          <div className="mx-auto flex max-w-md items-center gap-2 px-4 py-3">
            ...
            {picked.length === 2 ? (
              <Link
                ...
                className="shrink-0 rounded-full bg-gradient-to-r from-tt-green to-gs-red-strong px-4 py-2 text-xs font-bold text-white"
              >
                比較する →
              </Link>
            ) : (
        ...
        return (
          <div key={a.key} className="flex items-center gap-1">
            ...
            <span className="h-1.5 min-w-0 flex-1 overflow-hidden rounded-full bg-tt-gray30/30">
              {has && (
                <span
                  className="block h-1.5 rounded-full bg-gradient-to-r from-tt-green to-gs-red-strong"
    ...
    return (
      <div className="mt-4 rounded-2xl border-2 border-dashed border-tt-gray30/50 p-8 text-center text-sm leading-6 text-tt-gray70">
        ...
        <button
          type="button"
          onClick={onGoList}
          className="mt-3 inline-block rounded-full bg-gradient-to-r from-tt-green to-gs-red-strong px-5 py-2 text-xs font-bold text-white"
        >
          一覧から選ぶ →
        </button>
      </div>
    ...
    <div className="mt-3 pb-20">
      ...
      <div className="mt-4 flex gap-2">
        <Link
          ...
          className="flex-1 rounded-full bg-gradient-to-r from-tt-green to-gs-red-strong py-2.5 text-center text-sm font-bold text-white"
        >
          くわしく比較（みんなの回答・声）→
        </Link>
        <button
